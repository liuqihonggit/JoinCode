...
| gh 工具优先 | 操作 PR/Issue/Release 等 GitHub 资源时，优先使用 `jcc mcp_call gh_*` 工具（直调 GitHub REST API，无需系统 gh CLI），而非 PowerShell 脚本或手动操作 > ADR: [0073](docs/adr/0073-gh-rest-api-direct-call.md) |

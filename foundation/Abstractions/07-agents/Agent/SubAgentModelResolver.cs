...
/// <summary>
/// 子代理模型解析器 — 对齐 claude code src/utils/model/agent.ts
...
public static class SubAgentModelResolver
{
    ...
    /// <summary>
    /// 解析子代理最终生效模型(不含环境变量覆盖) — 对齐 claude code getAgentModel 主体逻辑
    ...
    /// <summary>
    /// 解析子代理最终生效模型(含 Bedrock 跨区域前缀继承) — 对齐 claude code getAgentModel 完整逻辑

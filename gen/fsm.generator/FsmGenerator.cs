...
public sealed class FsmGenerator : IIncrementalGenerator {
    ...
    private sealed class TransitionInfo {
        ...
        public TransitionInfo(string from, string evt, string to, long fromValue, long eventValue) { From = from; Event = evt; To = to; FromValue = fromValue; EventValue = eventValue; }
    }
}
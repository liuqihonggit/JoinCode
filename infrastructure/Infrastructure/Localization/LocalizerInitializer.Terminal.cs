...
public static partial class LocalizerInitializer
{
    private static void RegisterTerminalEntries(Dictionary<string, string> defaultEntries, Dictionary<string, string> zhEntries)
    {
        ...
        defaultEntries[StringKey.PermissionModeAsk] = "ask";
        defaultEntries[StringKey.PermissionModeAskShort] = "ask";
        defaultEntries[StringKey.PermissionModeBypass] = "bypass";
        defaultEntries[StringKey.PermissionModeBypassShort] = "bypass";
        ...
        zhEntries[StringKey.PermissionModeAsk] = "询问模式";
        zhEntries[StringKey.PermissionModeAskShort] = "询问";
        zhEntries[StringKey.PermissionModeBypass] = "全放行";
        zhEntries[StringKey.PermissionModeBypassShort] = "放行";

...
public sealed partial class NetworkConnectivityService : ServiceEntity, INetworkConnectivityService
{
    ...
    {
        get { using (_stateLock.Lock()) return _currentState; }
    }

    /// <inheritdoc/>
    public bool IsNetworkAvailable()
    {
        using (_stateLock.Lock()) return _currentState != NetworkConnectivityState.Offline;
    }

    /// <inheritdoc/>
    public bool IsVpnActive()
    {
        using (_stateLock.Lock()) return _currentState == NetworkConnectivityState.OnlineWithVpn;
    }

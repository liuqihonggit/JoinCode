...
public sealed partial class UnifiedCircuitBreaker
{
    ...
    public int ConsecutiveFailures
    {
        get { using (_lock.Lock()) { return _ctx.ConsecutiveFailures; } }
    }

    public int TotalFailures
    {
        get { using (_lock.Lock()) { return _ctx.TotalFailures; } }
    }

    public int TotalSuccesses
    {
        get { using (_lock.Lock()) { return _ctx.TotalSuccesses; } }
    }
    ...
    public DateTimeOffset? LastFailureTime
    {
        get { using (_lock.Lock()) { return _ctx.LastFailureTime == DateTimeOffset.MinValue ? null : _ctx.LastFailureTime; } }
    }

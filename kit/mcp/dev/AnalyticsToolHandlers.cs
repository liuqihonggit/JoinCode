...
public class AnalyticsToolHandlers {
    ...
    /// 获取使用统计报告
    /// </summary>
    [McpTool(AnalyticsToolNameEnumConstants.AnalyticsReport, "Get system usage statistics report", "analytics")]
    ...
    /// 获取工具使用统计
    /// </summary>
    [McpTool(AnalyticsToolNameEnumConstants.AnalyticsTools, "Get tool usage statistics details", "analytics")]
    ...
    /// 获取事件历史
    /// </summary>
    [McpTool(AnalyticsToolNameEnumConstants.AnalyticsEvents, "Get analytics event history", "analytics")]
    ...
    /// 导出分析数据
    /// </summary>
    [McpTool(AnalyticsToolNameEnumConstants.AnalyticsExport, "Export analytics data as JSON", "analytics")]
    ...
    /// 清除分析数据
    /// </summary>
    [McpTool(AnalyticsToolNameEnumConstants.AnalyticsClear, "Clear analytics history data", "analytics")]

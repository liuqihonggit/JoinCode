...
public partial class GitHubToolHandlers {
    ...
    /// </summary>
    [McpTool(GitHubToolNameEnumConstants.GhBranchSyncProtection, "同步分支保护规则: 从 PR 的 CI checks 提取 check 名, 更新分支保护的 required_status_checks(避免 CI 拆分后 auto-merge BLOCKED)", "github")]

...
public static partial class StringKey {
    ...
    public const string GoalEngineStarting = "GoalEngineStarting";
    public const string GoalEnginePaused = "GoalEnginePaused";
    public const string GoalEngineResumed = "GoalEngineResumed";
    public const string GoalEngineCleared = "GoalEngineCleared";
    public const string GoalEngineCompletedByModel = "GoalEngineCompletedByModel";
    public const string GoalEngineUnmetByModel = "GoalEngineUnmetByModel";
    public const string GoalEngineBudgetExhausted = "GoalEngineBudgetExhausted";
    ...
    public const string ServiceHostStartFailed = "ServiceHostStartFailed";
    public const string ServiceHostStarted = "ServiceHostStarted";
    public const string ServiceHostNotRunning = "ServiceHostNotRunning";
    public const string ServiceHostStopping = "ServiceHostStopping";
    public const string ServiceHostStopError = "ServiceHostStopError";
    public const string ServiceHostStopped = "ServiceHostStopped";
    public const string ServiceHostNotFound = "ServiceHostNotFound";
    public const string ServiceHostStartingService = "ServiceHostStartingService";
    public const string ServiceHostServiceStarted = "ServiceHostServiceStarted";
    ...
    public const string WorkflowAppStarting = "WorkflowAppStarting";
    public const string WorkflowAppStarted = "WorkflowAppStarted";
    ...
    public const string CronSchedulerTaskNotificationTitle = "CronSchedulerTaskNotificationTitle";
    public const string CronSchedulerStarted = "CronSchedulerStarted";
    ...
    public const string GoalHeartbeatCallbackFailed = "GoalHeartbeatCallbackFailed";
}
...
public static partial class StringKey
{
    ...
    public const string PermissionModeAsk = "PermissionModeAsk";
    public const string PermissionModeAskShort = "PermissionModeAskShort";
    public const string PermissionModeBypass = "PermissionModeBypass";
    public const string PermissionModeBypassShort = "PermissionModeBypassShort";

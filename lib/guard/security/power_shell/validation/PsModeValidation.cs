...
public static class PsModeValidation {
    ...
    private static readonly FrozenDictionary<string, string> CommonAliases =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) {
            [DangerCommandDefinitions.Rm] = "remove-item",
            [DangerCommandDefinitions.Del] = "remove-item",
            [DangerCommandDefinitions.Rd] = "remove-item",
            [DangerCommandDefinitions.Rmdir] = "remove-item",
            ["ri"] = "remove-item",
            [DangerCommandDefinitions.Erase] = "remove-item",
            [DangerCommandDefinitions.Sc] = "set-content",
            [DangerCommandDefinitions.Ac] = "add-content",
            ["clc"] = "clear-content",
            [DangerCommandDefinitions.Ni] = "new-item",
            [DangerCommandDefinitions.Cp] = "copy-item",
            [DangerCommandDefinitions.Copy] = "copy-item",
            [DangerCommandDefinitions.Mv] = "move-item",
            [DangerCommandDefinitions.Move] = "move-item",
            ["mkdir"] = "new-item",
            ["md"] = "new-item",
            ["cd"] = "set-location",
            ["sl"] = "set-location",

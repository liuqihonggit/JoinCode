...
public sealed class UnifiedSpawnMainAgentTests {
    ...
    public async Task DefinitionResolution_IsMainAgent_SkipsGetProfile() {
        ...
        await using var mw = new DefinitionResolutionMiddleware(roleRegistry.Object);
    ...
    public async Task PromptBuilding_IsMainAgent_SkipsBuildPrompt() {
        ...
        await using var mw = new PromptBuildingMiddleware(promptBuilder.Object);
    ...
    public async Task LifecycleSpawn_AgentExists_SkipsSpawn() {
        ...
        await using var mw = new LifecycleSpawnMiddleware(lifecycleManager.Object, contextAccessor.Object);
    ...
    public async Task WorktreeSpawn_IsMainAgent_SkipsWorktree() {
        ...
        await using var mw = new WorktreeSpawnMiddleware(worktreeService.Object, worktreeManager.Object);
    ...
    public async Task TeammatePane_IsMainAgent_SkipsPane() {
        ...
        await using var mw = new TeammatePaneMiddleware(contextAccessor.Object, NullLogger<TeammatePaneMiddleware>.Instance, layoutManager.Object);
    ...
    public async Task Transcript_IsMainAgent_SkipsTranscript() {
        ...
        await using var mw = new TranscriptMiddleware(clock.Object, contextManager: null, transcriptService: transcriptService.Object);
    ...
    public async Task RegisterMessage_IsMainAgent_SkipsRegister() {
        ...
        var contextAccessor = new Mock<ISubAgentContextAccessor>();
        await using var mw = new RegisterMessageMiddleware(messageBroker.Object, contextAccessor.Object, NullLogger<RegisterMessageMiddleware>.Instance);
